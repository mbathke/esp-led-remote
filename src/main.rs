...
use {
    ...
    mipidsi::{Builder, ColorInversion, Display, Orientation},
...
fn main() -> ! {
    ...
    let button = io.pins.gpio14.into_pull_up_input();
    ...
    loop {
        ...
        if button.is_low().unwrap() {
            ui.set_preset("Pre Two".try_into().expect("Expected to set text"));
        }
